    ...
    */
    ...
    public function is_a_string( $var, $input_name ){
        if( is_numeric( $var ) || is_bool( $var ) ){
            return 'Your ' . $input_name . ' is invalid';
        }
    ...
    public function is_price( $var, $input_name ){
        ...
        return 'Your ' . $input_name . ' should be a whole number or a number with 2 decimal digits'; 
    }

    public function is_blank_field( $post ){
        foreach( $post as $field ){
            if( $field === '' ){
                return 'One or more of your fields was blank.';
            }
        }
